    ...
    return (
        <div className='w-full h-screen flex justify-center items-center'>
            <div className='flex sm:flex-row justify-between sm:w-2/3 sm:h-1/2 h-full shadow-md flex-col-reverse w-full'>
                ...
                <Image 
                  className={clsx('sm:w-1/2 object-contain h-1/2 sm:h-full transition-all duration-150 translate-x-0' , {'transition-all duration-150 sm:-translate-x-full' : !isFirstStep})}  
                  src={mobileLogin} 
                  alt='mobile-login-vector'/>
            </div>
        </div>
    );
